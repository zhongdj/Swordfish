...
public class Principal implements IPrincipal {
    ...
    private Principal(String userName, String encryptedPassword) {
        ...
        this.encryptedPassword = encryptedPassword;
        {
            ...
            UPDATE_ACCOUNT_QL = "UPDATE " + userTable + " SET " + freezeCol + "= ?," + needResetPwdCol + " =?," + loginDateCol + " =?," + lockCol + " =?,"
                    + lastLoginDateCol + "=?," + invalidPwdAttemptsCol + " =?," + lastFailedTimeCol + "=?," + lastPwdChangeTimeCol + " =?," + loginTimesCol
                    + "=?," + accessDeniedTimesCol + "=?," + passwordCol + "=?, " + oldPasswordsCol + "=? WHERE " + usernameCol + "=?";
            if ( AuditPolicyAdvisor.getInstance().isAuditCompanyEnabled() ) {
                ...
                SELECT_COMPANY_QL = "SELECT c.* FROM " + companyTable + " c, " + userTable + " u   WHERE u." + fk + " = c." + companyIdCol + " AND u."
                        + usernameCol + " = ?";
            } else {
                SELECT_COMPANY_QL = "";
            }
            ...
            SELECT_GROUP_QL = "SELECT g.* FROM " + groupTable + " g, " + groupJoinTable + " j, " + userTable + " u " + " WHERE u." + usernameCol + " = j."
                    + userJoinCol + " AND j." + groupJoinCol + " = g." + groupNameCol + " AND u." + usernameCol + " = ?";
        }
    }
    ...
    public String toString() {
        ...
        return getClass().getName() + ":[ name: " + name + ", encryptedPassword: " + encryptedPassword + ", invalidPasswordAttempts:" + invalidPasswordAttempts
                + ", passwordLife:" + passwordLife + ", locked: " + locked + ", lockedMills: " + lockedDays + ", oldPasswords:" + oldPasswordString;
    }
}
