...
public class BundleUtils {
    ...
    public static String getBundledMessage(Class<?> cls, Locale locale, String bundle, String errorCode,
            Object[] messageVars) {
    ...
    public static String getBundledMessage(Class<?> cls, String bundle, String errorCode, Object... messageVars) {
        return MessageFormat.format(
                ResourceBundle.getBundle(bundle, Locale.CHINA, cls.getClassLoader()).getString(errorCode), messageVars);
    }
