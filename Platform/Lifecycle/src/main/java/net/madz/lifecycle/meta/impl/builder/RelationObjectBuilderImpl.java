...
public class RelationObjectBuilderImpl extends ObjectBuilderBase<RelationObject, StateMachineObject, RelationMetadata>
        implements RelationObjectBuilder {
    ...
    public RelationObjectBuilderImpl(final StateMachineObject parent, 
            final Field field, RelationMetadata template) {
    ...
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public RelationObjectBuilderImpl(final StateMachineObject parent, Method method,
    ...
    @Override
    public AnnotationMetaBuilder<RelationObject, StateMachineObject> build(Class<?> klass, StateMachineObject parent)
