...
public class StateMachineObjectBuilderImpl extends ObjectBuilderBase<StateMachineObject, StateMachineObject> implements
    ...
    private ReadAccessor<?> getEvaluator(KeySet keySet) {
        ...
        throw new IllegalStateException(
                "The evaluate is not found, which should not happen. Check the verifyRelationsAllBeCoveraged method.");
    }

    @Override
    public void validateInboundWhiles(InterceptContext context) {
        final Object target = context.getTarget();
        final Object transitionKey = context.getTranstionKey();
        final HashMap<Class<?>, Object> relationsInMethodParameters = evaluatorRelationsInMethodParameters(context);
