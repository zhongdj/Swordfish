...
public class StateMachineMetaDataImpl<R extends ITypedReactiveObject, S extends ITypedState<R, S>, T extends ITypedTransition> implements MetaData,
    ...
    protected final HashMap<ITypedTransition, TransitionMetaData> transitionIndexMap = new HashMap<ITypedTransition, TransitionMetaData>();
    ...
    @Override
    public TransitionMetaData getTransitionMetaData(ITypedTransition transition) {
