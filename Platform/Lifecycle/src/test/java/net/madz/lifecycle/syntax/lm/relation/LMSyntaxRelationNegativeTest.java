...
import net.madz.lifecycle.syntax.lm.relation.LMSyntaxRelationMetadata.S5;
...
public class LMSyntaxRelationNegativeTest extends LMSyntaxRelationMetadata {
    ...
    public final void test_LM_reference_an_invalid_relation_on_field() throws VerificationException {
        ...
        try {
            ...
            assertFailure(e.getVerificationFailureSet().iterator().next(), Errors.LM_REFERENCE_INVALID_RELATION,NLM_5.class.getName(), S4.Relations.R1.class.getName(), S5.class.getName());
            throw e;
        }
    }
    ...
    public final void test_LM_reference_an_invalid_relation_on_property() throws VerificationException {
        ...
        try {
            ...
            assertFailure(e.getVerificationFailureSet().iterator().next(), Errors.LM_REFERENCE_INVALID_RELATION,NLM_6.class.getName(), S4.Relations.R1.class.getName(), R1_S.class.getName());
            throw e;
        }
    }
}
