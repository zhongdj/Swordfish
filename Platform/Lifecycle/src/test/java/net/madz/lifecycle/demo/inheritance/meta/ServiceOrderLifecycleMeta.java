...
public interface ServiceOrderLifecycleMeta extends OrderLifecycleMeta {
    ...
    public class States extends OrderLifecycleMeta.States {
        ...
        @InboundWhiles({ @InboundWhile(relation = SummaryPlan.class,
                on = { SummaryPlanLifecycleMeta.States.Ongoing.class }, otherwise = {
                        @ErrorMessage(states = { SummaryPlanLifecycleMeta.States.VolumeLeftEmpty.class },
                                bundle = "scheduling", code = "100-0002"),
                        @ErrorMessage(states = { SummaryPlanLifecycleMeta.States.Done.class }, bundle = "scheduling",
                                code = "100-0003") }) })
