...
public class CallbackNegativeTests extends CallbackTestBase {
    ...
    @Test(expected = VerificationException.class)
    public void test_prestatechange_from_state_invalid() throws VerificationException, NoSuchMethodException, SecurityException {
        ...
        try {
            ...
            assertFailure(e.getVerificationFailureSet().iterator().next(), SyntaxErrors.PRE_STATE_CHANGE_FROM_STATE_IS_INVALID, S2.States.S2_State_A.class,
                    NLM_prestatechange_from_state_invalid.class.getMethod("interceptStateChange", LifecycleInterceptor.class), S1.class);
            throw e;
        }
    }

    @Test(expected = VerificationException.class)
    public void test_prestatechange_to_state_invalid() throws VerificationException, NoSuchMethodException, SecurityException {
        ...
        try {
            ...
            assertFailure(e.getVerificationFailureSet().iterator().next(), SyntaxErrors.PRE_STATE_CHANGE_TO_STATE_IS_INVALID, S2.States.S2_State_A.class,
                    NLM_prestatechange_to_state_invalid.class.getMethod("interceptStateChange", LifecycleInterceptor.class), S1.class);
            throw e;
        }
    }

    @Test(expected = VerificationException.class)
    public void test_poststatechange_from_state_invalid() throws VerificationException, NoSuchMethodException, SecurityException {
        ...
        try {
            ...
            assertFailure(e.getVerificationFailureSet().iterator().next(), SyntaxErrors.POST_STATE_CHANGE_FROM_STATE_IS_INVALID, S2.States.S2_State_A.class,
                    NLM_poststatechange_from_state_invalid.class.getMethod("interceptStateChange", LifecycleInterceptor.class), S1.class);
            throw e;
        }
    }

    @Test(expected = VerificationException.class)
    public void test_poststatechange_to_state_invalid() throws VerificationException, NoSuchMethodException, SecurityException {
        ...
        try {
            ...
            assertFailure(e.getVerificationFailureSet().iterator().next(), SyntaxErrors.POST_STATE_CHANGE_TO_STATE_IS_INVALID, S2.States.S2_State_A.class,
                    NLM_poststatechange_to_state_invalid.class.getMethod("interceptStateChange", LifecycleInterceptor.class), S1.class);
            throw e;
        }
    }
