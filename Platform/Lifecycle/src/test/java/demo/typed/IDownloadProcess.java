...
import static demo.typed.IDownloadProcess.TransitionEnum.Inactivate;
import static demo.typed.IDownloadProcess.TransitionEnum.Pause;
import static demo.typed.IDownloadProcess.TransitionEnum.Prepare;
import static demo.typed.IDownloadProcess.TransitionEnum.Receive;
import static demo.typed.IDownloadProcess.TransitionEnum.Remove;
import static demo.typed.IDownloadProcess.TransitionEnum.Restart;
import static demo.typed.IDownloadProcess.TransitionEnum.Resume;
import static demo.typed.IDownloadProcess.TransitionEnum.Start;


@TypedStateMachine(states = @TypedStateSet(StateEnum.class), transitions = @TypedTransitionSet(TransitionEnum.class))
public interface IDownloadProcess extends Serializable, ITypedReactiveObject {

    public static enum TransitionEnum implements ITypedTransition {
        @Recover
        @Timeout(3000L)
        Activate,
        @Corrupt
    ...
    public static enum StateEnum implements ITypedState<IDownloadProcess, StateEnum> {
        /**
         * Preconditions:
         * 
         ...
         * 
         * 1.2.2.1 File's directory (exists and can be written OR does not exist
         * but can be created under it's parent directory)
         * 
         * Postconditions:
         * 
         * 1. Download Task Meta-data file is created.
         * 
         * 2. URL, Folder, filename, thread number, state = "New" are stored in
         * the Meta-data file.
         */
        @Initial
        New(0, false, true),
         ...
         * Postconditions:
         * 
         * 1. Following information should be reset and set within the meta-data
         * file.
         * 
         ...
         * or re-created with deleting the pre-existing file (application
         * aborted before update status to Prepared).
         */
        @Running
        Queued(1),
        /**
         * Preconditions:
         * 
         * 1. All necessary meta information had been set, as is mentioned
         * above, such as: total length, resumable flag and etc.
         * 
         * 2. Target data file is created.
         * 
         * Postconditions:
         * 
         * 1. Resources required by down load had been allocated to this
         * downloadProcess.
         * 
