...
import net.madz.contract.sessions.CreatePouringPartSpecResponse;
...
public class UnitProjectResources {
    ...
    public CreatePouringPartSpecResponse addPouringPartSpec(@PathParam("unitProjectId") Long unitProjectId,
            List<CreatePouringPartSpecRequest> request) throws AppServiceException {
        System.out.println(request.toString());
        try {
            return bean.createPouringPartSpecs(unitProjectId, request);
