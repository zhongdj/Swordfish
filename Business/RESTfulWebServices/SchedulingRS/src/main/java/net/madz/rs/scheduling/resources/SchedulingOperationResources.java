...
public class SchedulingOperationResources {
     ...
     * <li>混凝土包含19个强度等级：C10, C15, C20, C25, ..., C100
     * 参见 {@link net.madz.common.entities.Concrete.StrengthGrade}</li>
     * <li>砂浆包含6个强度等级:M2.5, M5.0, M7.5, M10, M15, M20 
     * 参见 {@link net.madz.common.entities.Mortar.StrengthGrade}</li>
     * 
     * 
     */
    @GET
